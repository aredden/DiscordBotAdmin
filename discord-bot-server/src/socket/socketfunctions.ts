...
import { TypeMessageData, TypeMessage,
         EmojiMap, TypeEmoji, UpdateGuildArguments, UpdateGuildResult,
         UpdateChannelArguments, UpdateChannelResult, UpdateMemberResult,
         UpdateMemberArguments, UpdateMessageArguments,
         UpdateMessageResult } from "../types/discord-bot-admin-types";
 ...
 */
export const handleUpdateGuildRequest = async (updateArguments:UpdateGuildArguments, socket:Socket) => {
 ...
 * @param socket: SocketIO.Socket
 */
export const handleUpdateChannelRequest = async (updateArguments: UpdateChannelArguments, socket:Socket) => {
 ...
 * @param socket: SocketIO.Socket
 */
export const handleUpdateMemberRequest = async (updateArguments: UpdateMemberArguments, socket:Socket) => {
...
export const handleUpdateMessageRequest = async (updateArguments:UpdateMessageArguments, socket:Socket) => {
